...
<body>
    ...
    <div class="grid-container">
        ...
        <div class="main" style="color:rgba(230, 236, 240, 0.5);">
            <div class=''>
                <div class=''>
                    <!--TWEET WRAPPER-->
                    <p class="page_title mb-0 "style="color:black;">Home</p>
                            ...
                            <form method='post' enctype='multipart/form-data'>
                                ...
                                <div class='tweet_icons-wrapper'>
                                    ...
                                    <div class='t-fo-right'>
                                        ...
                                        <button class="button_tweet" type="submit" name="tweet" style="outline:none ;background-color:brown; color:white">POST</button>
