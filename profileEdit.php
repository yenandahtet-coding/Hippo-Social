...
<head>
    <title>Edit Profile - Hapi Hpai</title>
    <meta charset="UTF-8" />
...
<body>
    <div class="grid-container">
        ...
        <div class="main">
            ...
            <p class="page_title mb-0"><i class="fa fa-pencil-square-o mr-4" style="color:brown;"></i>Edit Profile</p>
...
-->
                        ...
                        <div class="edit-button d-flex">
                            <span>
                                <!-- <button class="new-btn mr-3" type="button" onclick="window.location.href='<?php echo BASE_URL.$user->username;?>'" value="Cancel" style="outline:none;">Cancel</button>  pyae's change-->

                                <button class="new-btn mr-3" type="button" onclick="cancelEdit();" style="outline:none;">Cancel</button>
                            </span>
                            <span>
