...
<body>
    <div class="grid-container"style="background:rgba(230, 236, 240, 0.5);">

        <?php require 'left-sidebar.php' ?>

        <!--Profile cover-->
        <div class="main" style="background:rgba(230, 236, 240, 0.5);">
            <div class='' style="background:rgba(230, 236, 240, 0.5);">
                <div class='' style="background:rgba(230, 236, 240, 0.5);">
                    <!--TWEET WRAPPER-->
                    <p class="page_title mb-0"><i class="fa fa-arrow-left mr-4"></i><?php echo $profileData->username; ?></p>
                            ...
                            <div class="profile-text">
                                ...
                                <div class="profile-follow mt-2 d-flex">
                                    <h6 class="mr-3 ml-1" style="font-weight: 700;"><?php echo $profileData->following; ?>
                                        <a href="<?php echo BASE_URL.$profileData->username; ?>following.php">
                                            <a href="<?php echo BASE_URL.$profileData->username; ?>" style="color:rgb(91, 112, 131);">Following</a>
                                        </a></h6>
                                    <h6 class="mr-3"style="font-weight: 700;"><?php echo $profileData->followers; ?>
                                    <a href="<?php echo BASE_URL.$profileData->username; ?>"style="color:rgb(91, 112, 131);">
                                        Followers
                                    </a></h6>
                                    <h6 style="font-weight: 700;">
                                    <?php echo $getFromT->countTweets($profileId); ?>
                                    <a style="color:rgb(91, 112, 131);">Post</a></h6>
                                </div>
                            </div>
                        </div>
                    </div>
