...
?>
           <div class="sidebar " style="margin-top:50px; background:rgba(230, 236, 240, 0.5); width:100%;">
            <ul style="list-style:none; ">
                ...
                <li><a href="<?php echo BASE_URL;?>i/notifications"><i class="fa fa-bell" aria-hidden="true" style="color:brown;"></i><span>Notifications</span><span id="notificaiton" class="ml-0"><?php if($notify->totalN > 0){echo '<span class="span-i">'.$notify->totalN.'</span>';}?></span></a></li>
                ...
                <!-- <li style="padding:10px 40px;"><button class="sidebar_tweet button addTweetBtn" style="outline:none; background-color:brown">POST</button></li> --> 
                <!-- <li><a href='<?php echo BASE_URL; ?>includes/logout.php'><i class="fa fa-power-off"></i><span >Logout</span></a></li> -->

                <!-- <li style="padding:20px 40px;"><button class="sidebar_tweet button addTweetBtn" style="outline:none; background-color:brown; ">
                <a href='<?php echo BASE_URL; ?>includes/logout.php' style="color:black:">Logout</button></li> -->
