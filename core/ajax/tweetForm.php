		...
		<div class="popwrap-inner">
			<div class="popwrap-header">
				...
				<span class="popwrap-h-right">
					<label class="closeTweetPopup" for="pop-up-tweet" ><i class="fa fa-times" aria-hidden="true" style="outline:none; color:brown;"></i></label>
				</span>
			</div>
			 ...
			 <form id="popupForm" method='post' enctype='multipart/form-data'>
                                ...
                                <div class='tweet_icons-wrapper'>
                                    ...
                                    <div class='t-fo-right'>
                                        ...
                                        <button class="button_tweet" type="submit" name="tweet" style="outline:none;">Post</button>
