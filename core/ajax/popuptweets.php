...
<div class="wrap4">
	<label for="tweet-show-popup-wrap">
		<div class="tweet-show-popup-box-cut">
			<i class="fa fa-times" aria-hidden="true" style="color:brown;"></i>
		</div>
	</label>
	...
	<div class="tweet-show-popup-inner">
		...
		<div class="tweet-show-popup-tweet-wrap">
			...
			<div class="tweet-show-popup-tweet-ifram mb-0" style="width:100px; height:200px; text-align:center;">
			     
				  <?php 
			  
			      if(!empty($tweet->tweetImage)){
					echo '<div "><img src="'.$tweet->tweetImage.'" style="height:200px; width:300px; text-align:center;"/></div>'; 
				}
			    ?>	
								...
								<div class="tweet-show-popup-comment-head-right">
								 	...
								 	<div class="tweet-show-popup-footer-menu">
										<ul>
											...
											'<li>
												<a href="#" class="more"><i class="fa fa-ellipsis-h" aria-hidden="true" style="color:brown;"></i></a>
												<ul> 
