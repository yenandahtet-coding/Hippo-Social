    ...
    <div class="retweet-popup-body-wrap">
      ...
      <div class="retweet-popup-footer"> 
        <div class="retweet-popup-footer-right">
          <button class="cancel-it f-btn" style="margin-bottom:10px; margin-left:20px; width:80px;">Cancel</button>
          <button class="delete-it" data-tweet="<?php echo $tweet->tweetID;?>" type="submit" style="margin-left:20px;">Delete</button>
        </div>
      </div>
    </div>
  </div>
