			...
			<div class="message-send">
				<div class="message-header">
					<div class="message-h-left">
						<label for="mass"><i class="fa fa-angle-left" aria-hidden="true" style="color:brown;"></i></label>
					</div>
					<div class="message-h-cen">
						<h4  style="color:brown;">New message</h4>
					</div>
					<div class="message-h-right">
						<label for="popup-message-tweet" ><i class="fa fa-times " aria-hidden="true" style="color:brown;"></i></label>
					</div>
				</div>
				<div class="form-group p-2">
					<h4 style="color:brown;">Send message to:</h4>
				...
				<div class="message-body">
					<h4  style="color:brown;">Recent</h4>
						...
						<div class="people-message" data-user="<?php echo $message->user_id;?>">
							<div class="people-inner">
								...
								<div class="name-right2" >
									<span><a href="#" style="color:aqua"><?php echo $message->screenName;?></a></span><span>@<?php echo $message->username;?></span>
								</div>
			...
			<script type="text/javascript" src="<?php echo BASE_URL;?>/assets/js/search.js"></script>
				...
				<div class="back">
					...
					<div class="back-inner">
						...
						<?php foreach($messages as $message) :?>
						<!--Direct Messages-->
							<div class="people-message" data-user="<?php echo $message->user_id;?>">s
								<div class="people-inner">
									<div class="people-img">
										<img src="<?php echo BASE_URL.$message->profileImage;?>"/>
									</div>
		...
		<div class="popup-message-body-wrap">
			...
			<div class="message-send2">
				<div class="message-header2">
					<div class="message-h-left">
						<label class="back-messages" for="mass"><i class="fa fa-angle-left" aria-hidden="true" style="color:brown;"></i></label>
					</div>
					<div class="message-h-cen">
						<div class="message-head-img">
						  <img src="<?php echo BASE_URL.$user->profileImage;?>"/><h4 style="color:brown;">Messages</h4>
						</div>
					</div>
					<div class="message-h-right">
					  <label class="close-msgPopup" for="message-body" ><i class="fa fa-times" aria-hidden="true" style="color:brown;"></i></label> 
					</div>
				</div>
				<div class="message-del">
					<div class="message-del-inner">
						<h4>Are you sure you want to delete this message? Think a while... </h4>
