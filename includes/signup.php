			...
			<div class="nav-wrapper">
				...
				<div class="nav-container">
					<div class="nav-second">
						<ul>
							<!-- <li><a href="#"><i class="fa-brands fa-linux" aria-hidden="true"style="color:white;"></i></a></li> -->
						</ul>
					</div><!-- nav second ends-->
					...
					<?php if ($_GET['step'] == '2') { ?>
						<div class='lets-wrapper'>
							<div class='step-letsgo'>
								...
								<p style="font-size:22px;">Our website is a constantly updating stream of the coolest, most important news, media, conversations for you.</p>
								<br>
